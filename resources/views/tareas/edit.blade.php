                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 grid-rows-1 gap-4">
                            <div>
                                <label class="form-control w-full">
                                    ...
                                    <input type="text" id="titulo" name="titulo" class="input input-bordered w-full" value="{{ old('titulo', $tarea->titulo) }}" />
                                </label>
                            </div>
                            <div>
                                <label class="form-control w-full">
                                    ...
                                    <select class="select select-bordered" name="estado">
                                        <option value="pendiente" {{ old('estado', $tarea->estado) == 'pendiente' ? 'selected' : '' }}>
                                            Pendiente</option>
                                        <option value="en_progreso" {{ old('estado', $tarea->estado) == 'en_progreso' ? 'selected' : '' }}>En
                                            progreso</option>
                            ...
                            <div>
                                <label class="form-control w-full">
                                    ...
                                    <input type="date" id="fecha_vencimiento" name="fecha_vencimiento" class="input input-bordered w-full" value="{{ old('fecha_vencimiento', $tarea->fecha_vencimiento) }}" />
                                </label>
                            </div>
                            <div class="md:col-span-3">
                                <label class="form-control">
                                    ...
                                    <textarea class="textarea textarea-bordered h-24" id="descripcion" name="descripcion">{{ old('descripcion', $tarea->descripcion) }}</textarea>
                                </label>
                            </div>
                        </div>
